			...
			<div class="row sbox">
				<div class="col-sm-2 menu-list">
					<ul class="nav list-unstyled">
						...
						<li>
							<a href="listqry.php" class="" data-toggle="tab">
				...
				<div class="col-sm-4 text-center addcatform">
					<br><br>
					<h2 class="text-center text-danger">Add New Category</h2>
					<form class="" role="form" action="" method="post">
						<br>
						<div class="input-group">
							<span class="input-group-addon">Category Name : <i class="fas fa-arrow-right"></i></span>
							<input type="text" class="form-control" id="catname">
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon">Icon : <i class="fas fa-arrow-right"></i></span>
							<input type="text" class="form-control" id="catname">
						</div><br>
						<input type="button" class="btn btn-default btn-lg" value="Add">
					</form>
				</div>
			</div>
		</div>
